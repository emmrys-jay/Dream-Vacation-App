...
const pool = mysql.createPool({
  host: process.env.DB_HOST || 'd-mysql', // Replace with your host if different
  user: process.env.DB_USER || 'root', // Replace with your MySQL username
  password: process.env.DB_PASSWORD || 'rootpassword', // Replace with your MySQL password
  database: process.env.DB_NAME || 'dreamvacations', // Replace with your database name
});
